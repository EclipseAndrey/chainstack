part of 'cr_bottom_sheet_route.dart';

///
///  Возвращает роут с PrimaryScrollController
///
...
WidgetWithChildBuilder _materialContainerBuilder(
  ...
  final color =
      backgroundColor ?? bottomSheetTheme.modalBackgroundColor ?? bottomSheetTheme.backgroundColor;
